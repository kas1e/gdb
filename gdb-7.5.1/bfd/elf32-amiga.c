...
void
_bfd_amiga_elf_symbol_processing (abfd, asym)
     bfd *abfd;
     asymbol *asym;
{
	printf("symbol = %s, base = %p, absvalue = %p, relvalue = %p\n",
		bfd_asymbol_name(asym), bfd_asymbol_base(asym), bfd_asymbol_value(asym),
		bfd_asymbol_value(asym) - bfd_asymbol_base(asym));
}
...
//#define elf_backend_symbol_processing		_bfd_amiga_elf_symbol_processing
